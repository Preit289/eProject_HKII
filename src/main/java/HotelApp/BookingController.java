...
public class BookingController {
    ...
    @FXML private TableColumn<BookingVM,String>  colCheckinDate;
    ...
    private void initialize() {
        ...
        // Format createdAt -> only date
        colCreatedAt.setCellValueFactory(c -> {
            LocalDateTime dt = c.getValue().createdAt();
            return new SimpleStringProperty(dt != null ? fmtDate.format(dt) : "");
        });

        // Format plannedCheckin -> only date
        colCheckinDate.setCellValueFactory(c -> {
            LocalDateTime dt = c.getValue().plannedCheckin();
            return new SimpleStringProperty(dt != null ? fmtDate.format(dt) : "");
        });
